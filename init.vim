...
let g:coc_global_extensions = ['coc-yank', 'coc-yaml', 'coc-json', 'coc-html', 'coc-java', 'coc-css','coc-vetur', 'coc-git', 'coc-pairs', 'coc-snippets', 'coc-tsserver', 'coc-java', 'coc-eslint', 'coc-translator']
